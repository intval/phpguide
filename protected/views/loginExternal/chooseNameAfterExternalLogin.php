...
<div class="clearfix">
    ...
    <div class="input">
        <input type="email" name="regmail" tabindex="7" id="regmail" title="אנחנו לא שולחים מיילים, פרסומות, ספאם או ויאגרה בלי שתבקש. אנחנו רק מציגים את האוואטר שלך מ-gravatar.com ומאפשרים לך לשחזר סיסמה. בעצם אתה יכול לראות בעצמך כל מה שאנחנו עושים, הקוד של האתר פתוח." />
    </div>
</div>
