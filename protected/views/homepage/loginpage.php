...
<form method="post" id="loginForm" dir="rtl" style="font-size: 17px; margin: 20px 0 0 50px;" >
    <div id="wrong" style="display:none;font-size:13px; text-align:right; background-color: #ff9999; padding:5px; width:270px;">שם משתמש או סיסמה לא נכונים</div>
    <table>
        <tr>
...
<script type='text/javascript'>
	...
	function login(result)
    {
        if( result == 'ok')
        {
            window.location = '<?=bu(e($return_location))?>';
        }
        else
        {
