...
// Available languages:
$config['langAvailable'] = array('he');
// Default language:
$config['langDefault'] = 'he';
// Language names:
...
// Available styles:
$config['styleAvailable'] = array('prosilver'); //array('beige','black','grey','Oxygen','Lithium','Sulfur','Cobalt','Mercury','Radium','prosilver','subsilver2','subblack2','subSilver','Core','MyBB','vBulletin');
// Default style:
...
$config['defaultChannelName'] = 'PHP Guide';
...
$config['messageTextMaxLength'] = 3040;
