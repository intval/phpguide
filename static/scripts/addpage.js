...
var modMoveToMenu ={divclass:'anylinkmenu', inlinestyle:'width:250px;', linktarget:'_new'}
...
getmenuHTML:function(menuobj,menutype){
	var menucontent=[]
	var frag=""
	for (var i=0; i<menuobj.items.length; i++)
	{
		var color = menuobj.items[i][1];
		if(menuobj.items[i][1]=='transparent')  color = '#1E0000;';
		if(menutype=="colors")	frag+='<li><a href="javascript:bbstyle(\'color\',\''+menuobj.items[i][1]+'\')" style="color:'+color+';">' + menuobj.items[i][0] + '</a></li>\n';
		else frag += '<li><a href="javascript:updateTheme('+menuobj.items[i][0]+',\'\')" >' + menuobj.items[i][1] + '</a></li>\n';
...
setupmenu:function(targetclass, anchorobj, pos,menutype){
	this.standardbody=(document.compatMode=="CSS1Compat")? document.documentElement : document.body
	var relattr=anchorobj.getAttribute("rel")
	dropmenuid=relattr.replace(/\[(\w+)\]/, '')
	var dropmenuvar=window[dropmenuid]
	var dropmenu=this.addDiv(null, dropmenuvar.divclass, dropmenuvar.inlinestyle) //create and add main sub menu DIV
	dropmenu.innerHTML=this.getmenuHTML(dropmenuvar,menutype)
...
init:function(targetclass,menutype){
        console.log('1');
	this.domready(function(){anylinkmenu.trueinit(targetclass,menutype)})
},

trueinit:function(targetclass,menutype){
	...
	for (var i=0; i<anchors.length; i++){
		...
		this.setupmenu(targetclass, anchors[i], i,menutype)
	}
}
